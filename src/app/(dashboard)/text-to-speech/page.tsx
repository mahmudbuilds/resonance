          ...
          <div className="lg:col-span-4 space-y-6 w-full max-w-full">
            <Card className="border border-border/70 dark:border-border/50 bg-card/70 dark:bg-card/40 backdrop-blur-xl shadow-xl overflow-hidden rounded-2xl flex flex-col group transition-all duration-500 hover:border-primary/30 w-full max-w-full">
              <CardHeader className="pb-4">
                ...
                <CardDescription className="truncate">Select and fine-tune your vocal model</CardDescription>
              </CardHeader>
            ...
            <Card className="flex flex-col border border-border/70 dark:border-border/50 bg-card/70 dark:bg-card/40 backdrop-blur-xl shadow-xl overflow-hidden rounded-2xl group transition-all duration-500 hover:border-primary/30 min-h-[450px] w-full max-w-full">
              <CardHeader className="border-b border-border/50 pb-4 flex flex-row items-center justify-between space-y-0 overflow-hidden gap-2">
                <div className="flex items-center gap-2 overflow-hidden min-w-0">
                  ...
                  <CardTitle className="text-lg truncate">Script Editor</CardTitle>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                   <div className="flex items-center gap-2">
                     <Label htmlFor="ssml" className="text-xs text-muted-foreground cursor-pointer hover:text-foreground transition-colors hidden sm:block">SSML support</Label>
                     <Switch id="ssml" />
                   </div>
                   <Button variant="outline" size="sm" className="h-8 rounded-lg bg-background/50 border-border/50 px-2 sm:px-3" onClick={() => setText("")}>
                  ...
                  <div className="divide-y divide-border/50">
                    ...
                    <div className="p-4 flex items-center justify-between hover:bg-muted/30 transition-colors gap-2 min-w-0">
                      <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                        ...
                        <div className="flex flex-col min-w-0 flex-1">
                           <p className="text-sm font-medium truncate w-full pr-2 text-foreground">Welcome to the future of voice generation. This is an incredible snippet that sounds very realistic.</p>
                           <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 mt-1 text-xs text-muted-foreground">
                             <span className="bg-background/80 border border-border/50 px-2 py-0.5 rounded-full font-medium shrink-0">Marcus</span>
                    ...
                    <div className="p-4 flex items-center justify-between hover:bg-muted/30 transition-colors gap-2 min-w-0">
                      <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                        ...
                        <div className="flex flex-col min-w-0 flex-1">
                           <p className="text-sm font-medium truncate w-full pr-2 text-foreground">Generate stunningly lifelike audio instantly.</p>
                           <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 mt-1 text-xs text-muted-foreground">
                             <span className="bg-background/80 border border-border/50 px-2 py-0.5 rounded-full font-medium shrink-0">Elara</span>
                             <span className="hidden sm:inline">•</span>
