...
export default function GlobalError({
  ...
  return (
    <div className="min-h-screen bg-[#030305] text-white font-sans">
      <nav className="w-full px-6 lg:px-16 pt-8 pb-6 border-b border-white/10">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            />
            <span className="text-base font-semibold text-white">Resonance</span>
          </Link>
          ...
          <div className="flex flex-wrap gap-3 mb-16">
            ...
            <Link href="/">
              <Button
                size="lg"
                variant="outline"
                className="rounded-md h-11 px-5 bg-transparent border-white/20 hover:border-white hover:bg-white/5 text-white font-medium text-sm"
              >
        ...
        <div className="border-t border-white/10 pt-10">
          ...
          <div className="grid sm:grid-cols-3 gap-px bg-white/10 border border-white/10 rounded-md overflow-hidden mb-6">
            ...
            <div className="bg-[#030305] p-4">
              ...
              <div className="text-white font-mono text-sm">Home page</div>
            </div>
          </div>

          <div className="bg-white/[0.02] border border-white/10 rounded-md p-5 text-zinc-300 font-mono text-sm leading-relaxed whitespace-pre-wrap">
            {error.message ||
      ...
      <footer className="w-full border-t border-white/10 mt-16 py-6 px-6 lg:px-16">
