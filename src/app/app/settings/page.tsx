                ...
                <div className="glass-panel rounded-3xl p-6 sm:p-8 shadow-xl shadow-foreground/10 border border-border relative overflow-hidden">
                  ...
                  <div className="mt-8 pt-6 border-t border-border flex justify-end">
                    <Button
                      ...
                      disabled={isUpdating}
                      className="shadow-lg shadow-primary/20 rounded-full h-11 px-8 bg-primary hover:bg-primary/90 hover:scale-105 text-foreground font-medium text-sm transition-all border-none disabled:opacity-50 disabled:hover:scale-100"
                    >
                      {isUpdating ? (
                        <>
