      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-12 animate-fade-up">
        ...
        <div className="grid lg:grid-cols-12 gap-8 w-full max-w-full">
          ...
          <div className="lg:col-span-7 space-y-6 stagger-1">
            <div className="glass-panel rounded-3xl p-6 sm:p-8 shadow-xl shadow-black/20 border border-white/5 h-full">
              ...
              <Accordion type="single" collapsible className="w-full space-y-4">
                {faqs.map((faq, i) => (
                  <AccordionItem 
                    key={i} 
                    value={`item-${i}`} 
                    className="glass-card border border-white/10 bg-white/[0.02] px-6 py-2 rounded-2xl data-[state=open]:border-primary/50 transition-colors"
                  >
                    <AccordionTrigger className="text-sm font-medium text-white hover:text-primary transition-colors hover:no-underline text-left py-4">
                      {faq.q}
                    </AccordionTrigger>
          ...
          <div className="lg:col-span-5 space-y-6 stagger-2">
            <div className="glass-panel rounded-3xl p-6 sm:p-8 shadow-xl shadow-black/20 border border-white/5 relative h-full flex flex-col">
              <div className="flex items-center gap-2 mb-6 pb-4 border-b border-white/5">
                <Mail className="w-4 h-4 text-primary" />
                <h2 className="text-sm font-semibold text-white tracking-wide">Direct Contact</h2>
              </div>

              <div className="flex-1 flex flex-col">
                <div className="space-y-4 mb-8">
                  <h3 className="text-xl font-heading font-semibold text-white tracking-tight">Need immediate assistance?</h3>
                ...
                <div className="glass-card rounded-2xl p-5 border border-white/10 bg-white/[0.02] flex items-center gap-4 mb-8 group transition-colors hover:border-white/20 hover:bg-white/5">
                  <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
                    <Mail className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-xs font-medium text-muted-foreground mb-0.5">Secure Email Support</div>
                    <div className="text-sm font-semibold text-white">support@resonance.ai</div>
                  </div>
                </div>

                <div className="mt-auto">
                  <Button asChild className="w-full shadow-lg shadow-primary/20 rounded-full h-11 px-8 bg-primary hover:bg-primary/90 hover:scale-105 text-white font-medium text-sm transition-all border-none">
